            ...
            <div style={{ marginTop: "30px", maxWidth: "360px" }}>
                ...
                {enableStep === "scanning" && qr && (
                    <div>
                        ...
                        <button onClick={() => { setEnableStep("idle"); setQr(null); setConfirmCode(""); setError(null); }}
                                style={{ marginLeft: "8px" }} disabled={loading}>
                            Cancel
                        </button>
                    </div>
                )}
                ...
                {twoFAEnabled && showDisable && (
                    <div>
                        ...
                        <button onClick={() => { setShowDisable(false); setDisableCode(""); setError(null); }}
                                style={{ marginLeft: "8px" }} disabled={loading}>
                            Cancel
                        </button>
                    </div>
